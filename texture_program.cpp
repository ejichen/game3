...
TextureProgram::TextureProgram() {
	program = compile_program(
		...
		" if(brightness > 0.7) brightColor = bloomColor.rgb;\n"
    ...
    "    }\n"
		" }\n"
		"	bloomBlurRes = result;\n"
 		// " bloomBlurRes += brightColor;\n"
		" result = vec3(1.0) - exp(bloomBlurRes * 0.13);\n"
		" result = pow(result, vec3(1.0 / 2.2));\n"
		" combine_result = vec4(result, 1.0) + fragColor;\n"
		// " combine_result = vec4(result, 1.0);\n"
		// " combine_result = bloomBlurRes;\n"
